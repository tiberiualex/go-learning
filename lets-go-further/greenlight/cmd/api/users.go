...
func (app *application) registerUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	// explictly helps to make our intentions clear to anyone reading the code.
	user := &data.User{
		Name:      input.Name,
		Email:     input.Email,
		Activated: false,
	...
	// Validate the user struct and return the error emssages to the client if any of
	// the checks fail
	...
	app.background(func() {
		...
		// templates, we create a map to act as a 'holding structrure' for the data. This
