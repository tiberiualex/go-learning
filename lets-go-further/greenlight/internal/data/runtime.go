...
// json.Unmarshler interface. IMPORTANT: Because UnmarshalJSON() needs to modify the
...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	// We expect that the incoming JSON valeu will be a string in the format
	...
	// the * operator to rereference the receiver (which is a pointer to a Runtime
	// type) in order to se the underlying value of the pointer
	*r = Runtime(i)
