...
func newTestDB(t *testing.T) *sql.DB {
	...
	// to use the "multiStatements=true" parameter in our DSN (connection string)
	// This instructs our MySQL database driver to support executing multiple SQL
	// statements in on db.Exec() call.
	...
	// called by Go when the current test (or sub-test) which calls newTestDB)_
