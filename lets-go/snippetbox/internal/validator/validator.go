...
type Validator struct {
	...
	// We will use this to hold any validation errors which are not related to
...
// MaxChars returns true if a value is not an empty string.
...
// variable is more performant than re-prasing the pattern each time we need it.
